...
foreach ($cats as $cat) { ?>
    ...
    <section class="block_<?= $cat->id + 2 ?> product-category-block" data-url="<?= \yii\helpers\Url::to(['product/category', 'id' => $cat->id]) ?>">
        <span><img src="/img/product_category_<?= $cat->id ?>.png" alt=""/></span>
